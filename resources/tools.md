...
### 4. **Google Colab**
   ...
   - **Link**: [Colab](https://colab.research.google.com/)
...
### 5. **Git & GitHub**
   ...
   - **Link**: [Git](https://git-scm.com/), [GitHub](https://github.com/)
...
### 18. **AWS SageMaker**
   ...
   - **Link**: [SageMaker](https://aws.amazon.com/sagemaker/)
...
### 25. **Optuna**
   ...
   - **Link**: [Optuna](https://optuna.org/)

### 26. **Hyperopt**
   - **Purpose**: Hyperparameter optimization
   - **Why**: Bayesian optimization
   - **Install**: `pip install hyperopt`
   - **Link**: [Hyperopt](http://hyperopt.github.io/hyperopt/)

### 27. **Ray Tune**
   - **Purpose**: Distributed hyperparameter tuning
   - **Why**: Scale to multiple machines
   - **Link**: [Ray Tune](https://docs.ray.io/en/latest/tune/index.html)
