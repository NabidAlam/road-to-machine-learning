...
**Coming from another field?** Start with [Domain tracks](resources/domain_tracks/README.md) (physics, life sciences, chemistry and materials, earth and environment, engineering, CS and software, business analytics, social and behavioral research, education and edtech, agriculture). Each syllabus orders the shared Modules `00`–`25` for research support or job-oriented study. It is an overlay, not a separate degree, and it does not guarantee a hire.
